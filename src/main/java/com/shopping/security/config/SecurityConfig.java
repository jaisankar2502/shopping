...
public class SecurityConfig {
    ...
    private Duration refreshTokenExpiry = Duration.ofDays(7);
     ...
     @NotNull
    private Duration paymentTokenExpiry = Duration.ofMinutes(5);
    ...
    public Duration getPaymentTokenExpiry() {
        return paymentTokenExpiry;
    }

    public void setPaymentTokenExpiry(Duration paymentTokenExpiry) {
